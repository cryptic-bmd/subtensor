...
fn test_return_per_1000_tao() {
    ...
    // 10_000 ZPHR total validator stake
    let total_stake = U64F64::from_num(10_000.0 * 1e9);
    // 1000 ZPHR emissions per day
    ...
    // We expect 82 ZPHR per day with 10% of total_stake
    ...
    let eps: f64 = 0.0005e9; // Precision within 0.0005 ZPHR
    assert!(
